...
namespace MWGui
{
    ...
    public:
        ...
        /// The animation group currently owned by the dialogue system. Mechanics
        /// uses this during the ambient->dialogue hand-off so it does not disable
        /// a newly-started dialogue pose that happens to have the same group name.
