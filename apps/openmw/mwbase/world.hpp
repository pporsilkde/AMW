...
namespace MWBase
{
    ...
    class World
    {
        ...
        public:
            ...
            /// Prepare a lightweight live world scene behind the title menu.
            /// The game state remains State_NoGame and scripts/mechanics stay paused.
            virtual bool startMainMenuScene(const std::string& cellName) = 0;
            virtual void updateMainMenuScene(float duration) = 0;
            virtual bool isMainMenuSceneActive() const = 0;
