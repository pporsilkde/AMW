...
namespace MWWorld
{
    ...
    class World final: public MWBase::World
    {
        private:
            ...
            bool mMainMenuSceneActive;
            bool mMainMenuCollisionDisabled;
            float mMainMenuSceneTime;
            int mMainMenuSceneLastShot;
            unsigned int mMainMenuSceneSeed;
            osg::Vec3f mMainMenuSceneCenter;
        ...
        public:
            ...
            bool startMainMenuScene(const std::string& cellName) override;
            void updateMainMenuScene(float duration) override;
            bool isMainMenuSceneActive() const override { return mMainMenuSceneActive; }
